...
func main() {
	...
	rutaArchivo := "/home/val/Desktop/code/AdventOfCode-2023/day05/input.txt"

	// Leer el contenido del archivo
	contenidoArchivo, err := os.ReadFile(rutaArchivo)
	if err != nil {
	...
	contenidoString := string(contenidoArchivo)
	fmt.Println("part #1: ", Part1(&contenidoString))
	fmt.Println("part #2: ", Part2(&contenidoString))
}
